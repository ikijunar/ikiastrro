...
([`d1-rasi.md`](d1-rasi.md)), **D9**
([`d9-navamsa.md`](d9-navamsa.md)), **D10**
([`d10-dasamsa.md`](d10-dasamsa.md)), **D60**
([`d60-shashtiamsa.md`](d60-shashtiamsa.md)) — are not
repeated here.

Read [`method.md`](method.md) for the
universal loop. Calculation rules and their sources:
[`../calculations.md`](../calculations.md) §2 and
[`../gap-and-coverage.md`](../gap-and-coverage.md) §2.
...
- **Confirm with:** D1 8th house, longevity method (`../calculations.md`), D30,
  D60. `full guide: TODO`
...
export but out of the engine's current scope — see `../gap-and-coverage.md` §2 and the
