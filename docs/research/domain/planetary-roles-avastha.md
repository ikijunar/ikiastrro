...
| **Chara Karaka** | ❌ | ❌ | Not built. Jaimini 8-fold (AK/AmK/BK/MK/PK/GK/DK + variant 8th), rank planets by degrees-within-sign (Rahu reversed). Input ready: `DegreesInSignDecimal`. `../../cli/gap-and-coverage.md` Tier-1 #3. Feeds Karakamsa + Jaimini rasi dashas. | ✅ (input only) | **MISSING** |
...
6. **Janma ghatis not persisted** — blocks Sayanadi and several `../../cli/gap-and-coverage.md`
...
- `../../cli/gap-and-coverage.md` — JHora feature-gap tiers (Chara Karaka = Tier-1 #3; Avasthas = Tier-3 #10)
- `../../cli/calculations.md` — dignity, combustion, nakshatra-lord, functional-nature engines
